...
async def _manage(_, msg):
    ...
    how += '2) Visit @mr_anshu_07 and define your problem **completely**, i.e, what you expected and what happened instead.'
    how += "If you don't get a reply, THEN GO TO HELL."
    await msg.reply(
        how,
